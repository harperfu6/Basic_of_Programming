...
let dijkstra kiten_r shuten_r =
  ...
  get_ekikan_kyori kiten shuten ekikan_tree
...
let t1 = dijkstra "shibuya" "gokokuji"
let t2 = dijkstra "myogadani" "meguro"
let test1 = dijkstra "shibuya" "gokokuji" = 9.8
let test2 = dijkstra "myogadani" "meguro" = 12.7000000000000028
